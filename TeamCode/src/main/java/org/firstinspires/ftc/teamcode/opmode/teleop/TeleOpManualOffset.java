...
//                hardwareMap.get(DcMotor.class, "vsl"));
    ...
    public void loop() {
        ...
        setOffsetPosition();
        setAlliance();
        shooterSystem.teleOpControl(otosSensor.getPosition(), gamepad2.left_bumper,gamepad2.right_bumper, gamepad2.left_trigger, gamepad1.a, gamepad1.b, new ElapsedTime());
