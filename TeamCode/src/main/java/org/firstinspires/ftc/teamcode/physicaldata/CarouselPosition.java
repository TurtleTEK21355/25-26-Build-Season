...
public enum CarouselPosition {
    ...
    CarouselPosition(DoubleSupplier servoPositionSupplier, boolean canIntake, boolean canShoot) {
        this.servoPositionSupplier = servoPositionSupplier;
        this.canIntake = canIntake;
        this.canShoot = canShoot;
    }

    /**
     * IMPORTANT: This now returns the CURRENT @Config value every time it's called.
     */
    public double getServoPosition() {
        return servoPositionSupplier.getAsDouble();
    }
